...
import type { Achievement } from '../../../shared/types/stats';
...
const AchievementCard = ({ achievement, cardBg, textColor }: AchievementCardProps) => {
                ...
                <Box flex={1} minW={0}>
                    ...
                    <Flex align="center" gap={2} mb={0.5}>
                        <Text fontSize="sm" fontWeight="700" color={unlocked ? textColor : 'gray.400'} noOfLines={1}>
                            {t(`stats.achievements.${achievement.id}.name`, { defaultValue: achievement.id })}
                        </Text>
                        {unlocked && (
                    ...
                    <Text fontSize="xs" color="gray.300" noOfLines={1} textAlign="left">
                        {t(`stats.achievements.${achievement.id}.desc`, { defaultValue: '' })}
                    </Text>
...
const AchievementsPage = () => {
    ...
    const { data: achievements, isLoading: loading } = useQuery<Achievement[] | null>({
